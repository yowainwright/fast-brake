...
**7x faster** than full mode, but may have false positives from strings and comments.
...
- ⚠️ **95% accuracy**: May detect features in strings/comments
- 🎯 **Use case**: Development builds, hot reloading

### Full Mode (Default)

**99.9% accuracy** with tokenizer validation to eliminate false positives.
